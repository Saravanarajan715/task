			...
			<div class="col-md-8">
				...
				<form method="post" onsubmit="myaction.collect_data(event, 'profile-edit')">
					<table class="table table-striped">
						...
						<tr><th><i class="bi bi-person-hearts"></i> age</th>
							<td>
						...
						<tr><th><i class="bi bi-calendar-fill"></i> dob</th>
							<td>
								<input value="<?=$row['dob']?>" type="text" class="form-control" name="dob" placeholder="dob">
								<div><small class="js-error js-error-dob text-danger"></small></div>
							</td>
						</tr>

						<tr><th><i class="bi bi-person-rolodex"></i> contact</th>
							<td>
