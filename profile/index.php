		...
		<div class="row col-lg-8 border rounded mx-auto mt-5 p-2 shadow-lg">
			...
			<div class="col-md-8">
				...
				<table class="table table-striped">
					...
					<tr><th><i class="bi bi-gender-ambiguous"></i> age</th><td><?=esc($row['age'])?></td></tr>
					<tr><th><i class="bi bi-gender-ambiguous"></i> dob</th><td><?=esc($row['dob'])?></td></tr>
					<tr><th><i class="bi bi-gender-ambiguous"></i> contact</th><td><?=esc($row['contact'])?></td></tr>
				</table>
			</div>
		</div>
	<?php else:?>
