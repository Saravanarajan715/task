<?php
	...
	if(empty($info['errors']) && $row)
	{
		...
		db_query("update users set firstname = :firstname,middlename= :middlename,lastname = :lastname,gender = :gender,age=: age,contact= :contact,dob=:dob,date = :date,email = :email $image_query $password_query where id = :id limit 1",$arr);
